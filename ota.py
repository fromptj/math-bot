...
async def answer(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    submit_button = {
        ...
        3 : [
            [InlineKeyboardButton('월~일까지의 43+45+35+40+33+51+40 개의 달걀을 7로 나누면 돼', callback_data='1')],
            [InlineKeyboardButton('월~일까지의 43+45+35+40+33+51+40 개의 달걀을 6으로 나누면 돼', callback_data='2')],
            [InlineKeyboardButton('월~일까지의 43+45+35+40+33+51 개의 달걀을 6으로 나누면 돼', callback_data='3')],
            [InlineKeyboardButton('월~일까지의 43+45+35+40+33+51 개의 달걀을 7으로 나누면 돼', callback_data='4')],
        ],
        4 : [
